...
# 1、创建浏览器对象
opt = Options()
# opt.add_argument('--disable-gpu')chrome.exe --remote-debugging-port=9527 --user-data-dir=“D:\AutomationProfile”
...
#     oo = 1
#     time.sleep(1)
#     space = web.find_element(By.XPATH, '//*[@id="__next"]/div[1]/div[1]/main/div[2]/form/div/div[2]/textarea')
#     space.clear()
#     space.send_keys("帮我写一下经典电影《" + i + "》的影评")
#     time.sleep(2)
#     web.find_element(By.XPATH, '//*[@id="__next"]/div[1]/div[1]/main/div[2]/form/div/div[2]/button').click()
#     time.sleep(150)
#     tx = web.find_element(By.XPATH,'//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[' + '%d' % 2 * oo + ']/div/div[2]/div[1]/div/div/p[1]').text+web.find_element(By.XPATH,'//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[' + '%d' % 2 * oo + ']/div/div[2]/div[1]/div/div/p[2]').text+web.find_element(By.XPATH,'//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[' + '%d' % 2 * oo + ']/div/div[2]/div[1]/div/div/p[3]').text+web.find_element(By.XPATH,'//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[' + '%d' % 2 * oo + ']/div/div[2]/div[1]/div/div/p[4]').text+web.find_element(By.XPATH,'//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[' + '%d' % 2 * oo + ']/div/div[2]/div[1]/div/div/p[5]').text
#     lt.append(tx)
#     time.sleep(2)
#     oo = oo + 1
#
...
for i in list:
    ...
    # print(pth)
    tx = web.find_element(By.XPATH,pth).text
    lt.append(tx)
    time.sleep(2)
    oo = oo+1
